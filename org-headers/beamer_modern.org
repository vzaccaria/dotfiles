...
#
# - Emoji.sty package (AFTER the previous steps)
#
#   1. Go into this folder
#   
#         kpsewhich -var-value=TEXMFHOME
# 
#   2. Download (just the sty file) from here:  https://github.com/henningpohl/latex-emoji.git
#
#      wget https://raw.githubusercontent.com/henningpohl/latex-emoji/master/emoji.sty
# 
#   3. Run texhash in the same directory
#
#      texhash .
#
#   3. verify with:
...
#+LATEX_HEADER: \newfontfamily\myunicodefallback{DejaVu Sans}
#+LATEX_HEADER: \fi

#+LATEX_HEADER: \iflinux
#+LATEX_HEADER: \newfontfamily\myunicodefallback{Menlo-Regular}
#+LATEX_HEADER: \fi
#+LATEX_HEADER: \newcommand{\uc}[1]{{\myunicodefallback #1}}
