...
\setmonofont[Scale=0.75]{Hasklig}
...
\tikzstyle{app}=[rectangle, fill=vzorange, draw=white, text=white, minimum width=2cm, align=center,scale=0.6, rounded corners]
\end{document}